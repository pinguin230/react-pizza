...
const Search = ({placeholder}) => {
  ...
  return (
      <div className={style.root}>
        ...
        <input value={searchValue} onChange={(e) => dispatch(setSearchQuery(e.target.value))} className={style.input} placeholder={placeholder}/>
        { searchValue && <svg className={style.closeIcon} onClick={()=> dispatch(setSearchQuery(''))} height="512px" id="Layer_1" version="1.1" viewBox="0 0 512 512" width="512px"
